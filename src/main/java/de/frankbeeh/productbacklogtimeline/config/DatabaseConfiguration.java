...
@Configuration
@EnableJpaRepositories("de.frankbeeh.productbacklogtimeline.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "de.frankbeeh.productbacklogtimeline.config.HerokuDatabaseConfiguration")
